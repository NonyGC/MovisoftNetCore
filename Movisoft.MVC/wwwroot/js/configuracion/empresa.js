var urlController = '/Configuracion/Empresa';
var tblPrincipal;
$(function () {
        ...
        columns: [
            ...
            { data: "Emprrazsocial" },
            {
                render: function (data, type, row) {
                    return `<a onclick="editar(${row.Emprcodi});"><i class="fa fa-pencil-square-o text-warning"></i></a> <a onclick="eliminar(${row.Emprcodi});"><i class="fa fa-trash text-danger"></i></a>`;
                }
            }
        ],
...
function guardar() {
    ...
    if (dataJson.Emprcodi) {
        url = `${urlController}/Edit/${dataJson.Emprcodi}`;
    }
    $.ajax({
        url: url,
        type: 'POST',
